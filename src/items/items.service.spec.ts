...
describe('ItemsServiceTest', () => {
  ...
  describe('findById', () => {
    it('正常系', async () => {
      ...
      itemRepository.findOne.mockResolvedValue(exptected);
  ...
  describe('create', () => {
    it('正常系', async () => {
      ...
      itemRepository.createItem.mockResolvedValue(exptected);
  ...
  describe('updateStatus', () => {
    ...
    it('正常系', async () => {
      ...
      expect(itemRepository.saveItem).toHaveBeenCalled();
    });
